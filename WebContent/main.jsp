		...
		<div id="demo" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="images/header/bannerImage0.jpg" alt="ban-img-0"
						width="1100" height="500">
				</div>
				<div class="carousel-item">
					<img src="images/header/bannerImage1.jpg" alt="ban-img-1"
						width="1100" height="500">
				</div>
				<div class="carousel-item">
					<img src="images/header/bannerImage2.jpg" alt="ban-img-2"
						width="1100" height="500">
				</div>
			</div>
