		...
		<div id="demo" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img src="images/header/bannerImage0.png" alt="ban-img-0"
						width="1100" height="500">
				</div>
				<div class="carousel-item">
					<img src="images/header/bannerImage1.png" alt="ban-img-1"
						width="1100" height="500">
				</div>
				<div class="carousel-item">
					<img src="images/header/bannerImage2.png" alt="ban-img-2"
						width="1100" height="500">
				</div>
			</div>
				...
				<div class="main-prd-list">
					<c:forEach var="product" items="${productList30}">
						<div class="main-prd-box">
							<a class="link-prod"
								href="/shop/product?cmd=detail&prodNo=${product.productId}"></a>
							...
							<ul class="main-prd-item">
								...
								<li class="prd-item-price"><fmt:formatNumber
										value="${product.price}" type="number" /></li>
								<!-- 가격 -->
