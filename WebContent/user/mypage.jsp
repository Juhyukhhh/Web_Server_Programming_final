		...
		<form method="post" action="user?cmd=update">
			...
			<div class="form-group input-group fg-x700">
				...
				<input name="name" class="form-control" type="text"
					value="${userUpdate.name}" readonly />
			</div>
			<!-- form-group// -->
			<div class="form-group input-group fg-x700">
				<div class="input-group-prepend">
				...
				<input name="username" class="form-control" placeholder="id 입력"
					value="${userUpdate.username}" type="text" readonly required />
			</div>
			<!-- form-group// -->
			<div class="form-group input-group fg-x700">
				<div class="input-group-prepend">
				...
				<input name="email" class="form-control" placeholder="Email 입력"
					value="${userUpdate.email}" type="email" required />
			</div>
			<!-- form-group// -->
			<div class="form-group input-group fg-x700">
				<div class="input-group-prepend">
				...
				<input name="phone" class="form-control"
					placeholder="휴대폰번호 입력('-' 포함)" value="${userUpdate.phone}"
					type="text" required />
			</div>
			<!-- form-group// -->
			<div class="form-group input-group fg-x700">
				...
				<input name="address" id="Addr" class="form-control"
					placeholder="주소 입력" type="text" value="${userUpdate.address}"
					readonly required /> <input type="button" value="주소 검색"
					onclick="goPopup();" />
			</div>
			<!-- form-group end.// -->
			<div class="form-group input-group fg-x700">
				...
				<input name="password" class="form-control" placeholder="비밀번호 입력"
					type="password" value="${userUpdate.password}" required />
			</div>
			<!-- form-group// -->
...
<script>
	function goPopup() {
		...
		var pop = window.open("/hyukshop/user/jusoPopup.jsp", "pop",
