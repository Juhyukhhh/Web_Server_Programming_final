		...
		<form method="post" action="user?cmd=naverJoin">
			...
			<div class="form-group input-group fg-x700">
				...
				<input name="phone" class="form-control"
					placeholder="휴대폰번호 입력('-' 포함)" value="${phone}" type="text"
					required />
			</div>
			<!-- form-group// -->
			<div class="form-group input-group fg-x700">
				...
				<input name="address" id="Addr" class="form-control"
					placeholder="주소 입력" type="text" readonly required
					onkeypress="return false;"
					style="caret-color: transparent !important;" /> <input
					type="button" value="주소 검색" onclick="goPopup();" />
			</div>
			<!-- form-group end.// -->
			<div class="form-group input-group fg-x700">
				<div class="input-group-prepend">
...
<script>
	function goPopup() {
		var pop = window.open("/final_shoppingmall/user/jusoPopup.jsp", "pop",
