		...
		<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
			<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
				...
				<head>
					...
					<!-- End of Script -->
					<title>Doggy Handy</title>
				</head>

				<body>
					<a id="header-banner-a" href="<%=request.getContextPath()%>/product?cmd=main"><img
							src="<%=request.getContextPath() %>/images/header/bannerImage.jpg" id="header-banner" /></a>
					<header>
						<div id="header-first">
							<div id="header-logo">
								<a href="<%=request.getContextPath()%>/product?cmd=main"><img src="<%=request.getContextPath() %>/images/header/logo_1.png"
							...
							<div class="btn-group header-second-btn-box">
								<c:choose>
									<c:when test="${pageContext.request.requestURI eq '/shop/main.jsp' }">
										<button type="button" id="header-sec-home" onclick="location.href='/jsp-hyukshop-master/';"
											class="btn btn-basic header-second-btn-group border-btm-red">
											홈</button>
									</c:when>
									<c:otherwise>
										<button type="button" id="header-sec-home" onclick="location.href='/jsp-hyukshop-master/product?cmd=main';"
								...
								<c:choose>
									<c:when test="${pageContext.request.requestURI eq '/shop/product/rank.jsp' }">
										<button type="button" id="header-sec-rank"
											class="btn btn-basic header-second-btn-group border-btm-red"
											onclick="location.href='/jsp-hyukshop-master/product?cmd=rank';">랭킹</button>
									</c:when>
									<c:otherwise>
								...
								<c:choose>
									<c:when test="${pageContext.request.requestURI eq '/shop/product/categories.jsp' }">
										<button type="button" id="header-sec-rank"
											class="btn btn-basic header-second-btn-group border-btm-red"
											onclick="location.href='/jsp-hyukshop-master/product?cmd=category';">전체상품</button>
									</c:when>
									<c:otherwise>
										<button type="button" id="header-sec-rank" style=""
											class="btn btn-basic header-second-btn-group"
